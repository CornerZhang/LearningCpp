...
namespace inf {
    ...
    *******************************************************************************/
    ...
    void short_sort( ElementIter lo, ElementIter hi, cmp comp ) {
        ElementIter p, max;
    ...
    /***
    *quick_sort(base, num, comp) - quicksort function for sorting arrays
    *
    *Purpose:
    ...
    *******************************************************************************/
    template< class ElementIter, class cmp >
    void quick_sort( ElementIter begin, ElementIter end, cmp comp ) {
...
recurse:
    ...
    **/
    ...
    class leonardo_number
    {
    public:
        /**  Default ctor.  **/
        leonardo_number (void) : b (1), c (1)
        { return; }

        /**  copy ctor.  **/
        leonardo_number (const leonardo_number & _l)  : b (_l.b), c (_l.c)
        { return; }
    ...
    **/
    template <typename T>
    void sift (T * _m, unsigned _r, leonardo_number _b)
    {
        unsigned r2;
    ...
    **/
    template <typename T>
    void trinkle (T * _m, unsigned _r, unsigned long long _p, leonardo_number _b)
    {
        while (_p)
        {
            for ( ; !(_p % 2); _p >>= 1)  ++_b;
    ...
    **/
    template <typename T>
    void semitrinkle (T * _m, unsigned _r, unsigned long long _p, leonardo_number _b)
